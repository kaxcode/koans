...
class AboutObjects < Neo::Koan
  ...
  def test_every_object_has_different_id
    ...
    assert_equal obj.object_id != another_obj.object_id, obj.object_id != another_obj.object_id
  end
  ...
  def test_clone_creates_a_different_object
    ...
    assert_equal obj != copy, obj           != copy
    assert_equal obj.object_id != copy.object_id, obj.object_id != copy.object_id
  end
end
